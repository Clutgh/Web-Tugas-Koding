          ...
          >
            {looped.map((project, i) => (
              <div key={i} className="w-1/3 flex-shrink-0">
                <div className="group h-full p-6 glass rounded-2xl shadow-card hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
